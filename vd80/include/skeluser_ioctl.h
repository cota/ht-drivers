...
#define Vd80IoctlGET_ANALOGUE_TRIGGER                   SKELU_IOR(Vd80NumGET_ANALOGUE_TRIGGER,Vd80DrvrAnalogTrig)
...
#define Vd80IoctlGET_TRIGGER_CONFIG                     SKELU_IOR(Vd80NumGET_TRIGGER_CONFIG,Vd80DrvrTrigConfig)
