...
/* API for new drivers */
extern int vme_request_irq(unsigned int, void (*)(void *),
			   void *, const char *);
...
extern unsigned long return_controller(struct vme_mapping *);
extern int vme_intset(int, void (*)(void *), void *, void *);
