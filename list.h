 ...
 * @file list.h
 *
 * @brief Unearth list to the user space. Thxs to @e modinit tools!
 *
 * @author Yury GEORGIEVSKIY
 *
 * @date long time ago.
 *
 * Taken from Linux Kernel Source's list.h -- GPL.
 *
 * @version 1.0  ygeorige  30/06/2008  Creation date.
 */
...
/* Extra handy list definitions. (see the header for more detailes)
   In a separate file, because drivers also are using this marcoses */
#include "list_extra.h"
