...
static unsigned long  mw_bo_color;     /* Main window border color */
static unsigned long  mw_bk_color;     /* Main window background color */
...
void DisplayLine(char *txt, int row, int bell) {
